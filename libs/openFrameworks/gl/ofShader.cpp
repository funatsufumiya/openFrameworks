...
////        glGetProgramiv(program, GL_ACTIVE_UNIFORM_MAX_LENGTH, &uniformMaxLength); // commented out for PGL
//
//        GLint count = -1;
//        GLenum type = 0;
//        GLsizei length;
...
////            glGetActiveUniform(program, i, uniformMaxLength, &length, &count, &type, uniformName.data());  // commented out for PGL
...
////        GLsizei length;
////        GLint location;
//////        glGetActiveUniform(program, i, uniformMaxLength, &length, &count, &type, uniformName); // commented out for PGL
